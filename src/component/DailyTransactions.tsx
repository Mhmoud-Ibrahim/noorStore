...
export default function DailyTransactions() {
  ...
  return (
    ...
    >
      <Helmet>
        <title>الحسابات اليومية | الكاشير الفوري</title>
      </Helmet>
      ...
      <div className="container mt-4">
        <div className="d-flex flex-wrap justify-content-between align-items-center mb-4">
          <h2 className="fw-bold m-0">
            📝 دفتر{" "}
            <span style={{ color: "#ff6600" }}>المعاملات الكاش والمصاريف</span>
          </h2>
        ...
        <div className="row g-4">
          ...
          <div className="col-md-5">
            <div
              className="p-4 rounded-4 bg-dark shadow-sm"
              style={{ border: "1px solid #333" }}
            >
              <h5 className="fw-bold mb-4" style={{ color: "#ff6600" }}>
                ➕ إضافة حركة خزينة فورية
              </h5>
              ...
              <div className="btn-group w-100 mb-4" role="group">
                ...
                <button
                  type="button"
                  className={`btn fw-bold ${txType === "expense" ? "btn-danger text-white" : "btn-outline-secondary text-white"}`}
              ...
              <form onSubmit={handleSubmit}>
                  ...
                  <>
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        placeholder="زبون محل افتراضي..."
                      />
                    </div>
                    <div className="mb-3">
                      <label className="small text-light opacity-75 mb-2">
                        اختر الصنف المباع من المخزن
                      </label>
                      <select
                ...
                (
                  <>
                    <div className="mb-3">
                      <label className="small text-light opacity-75 mb-2">
                        قيمة المبلغ المدفوع مخصوماً (ج.م)
                      </label>
                      <input
                        type="number"
                        min="1"
                    ...
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        placeholder="مثال: فاتورة كهرباء، إيجار، مستلزمات..."
                      />
                    </div>
                  </>
                )}
                ...
                {txType === "sale" && (
                  <div className="mb-3">
                    ...
                    <textarea
                      ...
                      placeholder="شروط مخصصة للبيع أو تعليقات..."
                    ></textarea>
                  </div>
                )}
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`btn w-100 fw-bold py-2 mt-2 ${txType === "sale" ? "btn-warning text-dark" : "btn-danger"}`}
                >
                  {loading
                    ? "جاري الحفظ والتحديث..."
                    : "⚡ تأكيد وحفظ حركة الخزينة فورا"}
                </button>
              </form>
            </div>
          </div>
          ...
          <div className="col-md-7">
            ...
            >
              <h5 className="fw-bold mb-4 text-secondary">
                🔍 تفاصيل جرد ومطابقة الحسابات والربحية التقديرية للصنف
              </h5>

              {txType === "sale" && selectedProduct ? (
                <div className="text-start">
                  <div
                    className="d-flex align-items-center gap-4 mb-4 p-3 rounded-3 bg-black"
                    style={{ borderRight: "4px solid #ff6600" }}
                  >
                    <img
                      src={selectedProduct.imageCover || "https://placehold.co"}
                    ...
                    <div>
                      ...
                      <span
                        className={`badge ${selectedProduct.stock > 5 ? "bg-success" : "bg-danger"}`}
                      >
                        المخزون الحالي بالمستودع: {selectedProduct.stock} قطعة
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="row g-3 text-center">
                    <div className="col-6 col-sm-3">
                      <div className="p-3 bg-black rounded-3">
                    ...
                    <div className="col-6 col-sm-3">
                      <div className="p-3 bg-black rounded-3">
                        ...
                        <span className="fw-bold text-muted">
                          {selectedProduct.costPrice || 0} ج.م
                        </span>
                      </div>
                    </div>
                    <div className="col-6 col-sm-3">
                      ...
                      >
                        ...
                        <span className="fw-bold text-warning">
                          {selectedProduct.price * formData.quantity} ج.م
                        </span>
                      </div>
                    </div>
                    <div className="col-6 col-sm-3">
                ...
                <div className="text-center py-5">
                  ...
                  <h4 className="fw-bold text-danger">
                    تنبيه: سيتم خصم {formData.amount} ج.م مباشرة من الصندوق
                    لإجمالي المصاريف
                  </h4>
                  <p className="text-secondary mt-2">
                    بيان السحب: {formData.notes || "لم يُحدد تفاصيل بعد"}
                  </p>
                </div>
              ) : (
                <div className="text-center py-5 text-muted">
                  ...
                  <p className="fw-bold">
                    بانتظار اختيار منتج أو تدوين قيمة المصاريف لحساب الحسابات
                    والربحية التقديرية بدقة هنا قبل الترحيل.
                  </p>
                </div>
              )}
            </div>
