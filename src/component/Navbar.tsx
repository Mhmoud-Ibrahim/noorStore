...
import logo from '../assets/logonoor.jpeg';
function Navbar() {
                    ...
                    <motion.div initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }}>
                        <Link className="navbar-brand fw-bold m-0" to="home" style={{ color: '#ff6600' }}>
                            <Link to="/" className="text-decoration-none ">
                                <div className="rounded-circle p-0 overflow-hidden border border-2" style={{ width: '35px', height: '35px', borderColor: '#ff6600' }}>
                                        <img src={logo} alt="logo" className="w-100 h-100 mb-5 object-fit-cover" />
                                </div>
                            </Link>
                        </Link>
                    </motion.div>
