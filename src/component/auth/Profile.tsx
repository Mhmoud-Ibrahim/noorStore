          ...
          <div className="row g-4 justify-content-center">
            ...
            >
              <div className="position-relative d-inline-block mb-3">
                ...
                >
                  <img
                    src={`${user?.userImage}?t=${new Date().getTime()}`}
              ...
              <h3 className="fw-bold mb-1" style={{ color: "#ff6600" }}>
                {user?.name}
              </h3>
              <p className="text-secondary small mb-3">{user?.email}</p>
              <span className="badge rounded-pill px-3 py-2 bg-secondary mb-4">
                {user?.role}
              </span>
            ...
            {(user?.role === "admin" || user?.role === "employee") && (
              ...
              >
                ...
                <div className="list-group list-group-flush">
                  ...
                  >
                    <span>
                      <i className="fas fa-users-cog me-2 text-info"></i> إدارة
                      المستخدمين
                    </span>
                  ...
                  >
                    <span>
                      <i className="fas fa-box me-2 text-info"></i> إدارة
                      المنتجات
                    </span>
                    <i className="fas fa-chevron-left small opacity-50"></i>
                  </Link>
